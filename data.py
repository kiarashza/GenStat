...
def list_graph_loader( graph_type, _max_list_size=None, return_labels=False, limited_to=None, save_dataset=False):
  list_adj = []
  list_x =[]
  list_labels = []
  ...
  if save_dataset:
      graphs_to_writeOnDisk = [gr.toarray() for gr in list_adj]
      np.save(graph_type, graphs_to_writeOnDisk, allow_pickle=True)
