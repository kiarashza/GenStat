...
parser.add_argument('-v', dest="Vis_step", default=5000, help="model learning rate")
...
parser.add_argument('-lr', dest="lr", default=0.05, help="model learning rate",type=float) # henerally   0.0003 works well # 0005 for pca+ diagonal varianve
...
parser.add_argument('-beta', dest="beta" , default=0, help="beta coefiicieny", type=float)
...
parser.add_argument("-desc_fun", dest="desc_fun" , default= [ "in_degree_dist", "HistogramOfCycles"], help="the descriptor function which should be used", nargs='+',)
...
parser.add_argument('-scheduler_type', dest="scheduler_type" , default="OneCyle", help="OneCyle of or CyclicLR", )
...
def get_subGraph_features(org_adj, subgraphs_indexes, kernel_model,batchSize = 100):
    subgraphs =[]
    ...
    if kernel_model!=None:
        ...
        for i in range(0,len(org_adj),batchSize):
            target_kelrnel_val.append(kernel_model(subgraphs[i:i+batchSize]))
        wholeDatasetStats = []
