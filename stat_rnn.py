...
def Diam_stats(graph_list):
    ...
    print("Average Diam:",str(np.average(graph_list)), "Var:",str(np.var(graph_list)), "Max Diam:",str(np.max(graph_list)),"Min Diam:",str(np.min(graph_list)))
...
def mmd_eval(generated_graph_list, original_graph_list, diam = False):
    try:
        ...
        return(' degree: '+str(mmd_degree) +' clustering: ' + str(mmd_clustering) + ' orbits: '+str(mmd_4orbits)+" Spec: "+str( mmd_spectral)  +  " diameter: " + str(mmd_diam))
    except Exception:
        print(Exception)
...
if __name__ == '__main__':
    # from data import *
    # dir = "/local-scratch/kiarash/AAAI/Arxived_BaseLines/StatisticBasedModels/StatisitBasedModels/MMD_statistic_GMMs_result_.1.1/"
    # refrence_file = "_test_set_.npy"
    # generated_file = "_generated_set_.npy"
    # evl_all_in_dir(dir, refrence_file, generated_file)
    # exit()
    # # dataset = "cora"
    # # model = ["graphit","arga"]
    # # for m in model:
...
# GRAN DD
    ...
    # Pig PMI 10000
    models= []
    test_fname= "C:/git/BIGGon13/data/PVGAErandomGraphs_10000/test-graphs.pkl"
    # test_fname = "C:/git/AAAI/Graph-Generative-Models/MMD_AvePool_FC_PVGAErandomGraphs_graphGeneration_KernelAugmentedWithTotalNumberOfTrianglesBFSTrue200001661371965.198304/testGraphs_adj_.npy"
    pred_fname = "C:/git/BIGGon13/data/PVGAErandomGraphs_10000/generated.npy"
    models.append([test_fname,pred_fname, None])

#PVGAErandomGraphs_10000/generated.npy    
# Pig PMI 10000
    models= []
    test_fname= "C:/git/BIGGon13/data/PVGAErandomGraphs_10000/test-graphs.pkl"
    #test_fname = "C:/git/AAAI/Graph-Generative-Models/MMD_AvePool_FC_PVGAErandomGraphs_graphGeneration_KernelAugmentedWithTotalNumberOfTrianglesBFSTrue200001661371965.198304/testGraphs_adj>
    pred_fname = "C:/git/BIGGon13/data/PVGAErandomGraphs_10000/generated.npy"
    models.append([test_fname,pred_fname, None])

    models= []
    test_fname= "/local-scratch/kiarash/AAAI/bigg/mnist/test-graphs.pkl"
    #test_fname = "C:/git/AAAI/Graph-Generative-Models/MMD_AvePool_FC_PVGAErandomGraphs_graphGeneration_KernelAugmentedWithTotalNumberOfTrianglesBFSTrue200001661371965.198304/testGraphs_adj>
    pred_fname = "/local-scratch/kiarash/AAAI/bigg/mnist/241generated.pkl"


    models = []
    test_fname = "/localhome/kzahirni/Downloads/TheBigShuffles/PTC_lattice_graph/test-graphs.pkl"
    pred_fname = "/localhome/kzahirni/Downloads/TheBigShuffles/PTC_lattice_graph/generated.npy"
    models.append([test_fname,pred_fname, None])
    ...
    for model in models:
        ...
        mmd_eval(generated_graphs, test_list_adj[:1000], True)
        print("=============================================================================")
